...
class KerjaSamaController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','manage','admin'),
				'users'=>array('@'),
			),
	...
	public function actionView($id)
	{
		...
		$crit->addCondition('id_kerjasama!='.$model->id_kerjasama);
		$crit->limit='10';
		$modelSejenis=KerjaSama::model()->findAll($crit);
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['KerjaSama']))
		{
			...
			$model->deadline=$this->tanggal($_POST['KerjaSama']['deadline']);
	...
	public function actionIndex($provinsi='',$kota='')
	{
	    ...
	    $pembeli=new CActiveDataProvider('KerjaSama', array(
	    'criteria'=>$criteria,
	    'pagination'=>array(
	        'pageSize'=>20,
	    ),
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='kerja-sama-form')
		{
