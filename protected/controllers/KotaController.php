...
class KotaController extends Controller
{
	...
	public function loadModel($id)
	{
		...
		public function actionKotaGanti()
	{
		$idprov = $_POST['idprov'];
		//$data = Kota::model()->findAll(array('condition' => 'id_provinsi=:idprov', 'params' => array(':idprov'=>"14")));
		//$data = "bayu";
		$data = $idprov;
		//$data = Kota::model()->findByPk("slo");
		//$data = Provinsi::model()->findAll();
		$this->renderPartial('renderkota', $data, false, true);
	}
